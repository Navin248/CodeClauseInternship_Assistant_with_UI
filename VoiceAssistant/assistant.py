...
system_instruction = ("You are Robo, A helpful and informative ai assistant. Give short "
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                if convo.last.text.startswith("/c"):
                    ...
                    insertText(self.chatbox, "Robo: " + response + "\n")
                    self.root.update_idletasks()
                    engine.say(response)
                else:
                    insertText(self.chatbox, "Robo: " + convo.last.text + "\n\n")
                    self.root.update_idletasks()
